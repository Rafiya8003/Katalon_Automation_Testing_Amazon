...
WebUI.click(findTestObject('Object Repository/Amazon_Account_Management/span_Hello, Pic'))

WebUI.click(findTestObject('Object Repository/Amazon_Account_Management/h2_Your Addresses'))

WebUI.click(findTestObject('Object Repository/Amazon_Account_Management/a_Edit'))

WebUI.click(findTestObject('Object Repository/Amazon_Account_Management/input_address-ui-widgets-enterAddressLine1'))

WebUI.click(findTestObject('Object Repository/Amazon_Account_Management/input_cvf_captcha_captcha_action'))

WebUI.verifyElementText(findTestObject('Object Repository/Amazon_Account_Management/h4_Address saved'), 'Address saved')
